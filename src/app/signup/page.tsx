...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="blob-bg bg-primary w-[400px] h-[400px] top-[-50px] right-[-100px]" />
      <div className="blob-bg bg-blue-500 w-[500px] h-[500px] bottom-[-150px] left-[-150px] animation-delay-2000" />
        ...
        <div className="relative w-full max-w-md">
          ...
          <Card className="glass-card relative rounded-3xl border-0 ring-1 ring-border/50">
            <CardHeader className="space-y-2 pb-6 pt-8 px-8 text-center">
              <CardTitle className="text-3xl font-bold font-headline tracking-tight text-gradient">Create Account</CardTitle>
              <CardDescription className="text-base text-muted-foreground">Enter your details to sign up.</CardDescription>
            </CardHeader>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <Button type="submit" size="lg" className="w-full rounded-full h-12 text-md shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all mt-4" disabled={form.formState.isSubmitting}>
                    {form.formState.isSubmitting ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : <UserPlus className="mr-2 h-5 w-5" />}
                    Sign Up
                  </Button>
                </form>
              </Form>
